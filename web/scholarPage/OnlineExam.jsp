<%@ page import="com.project1.vo.OnlineExamBean" %><%--
...
<div class="Body">
    ...
    <div class="main">
        ...
        <c:forEach var="row" items="${users.rows}" begin="0" end="1">
            <c:set var="id" value="${row.address}"></c:set>
        </c:forEach>
        ...
        <c:if test="${empty sessionScope.questions}">
            ...
            <sql:update var="count" scope="page" dataSource="${userdb}">
                insert into examrecord(address,exam_description_id) values(?,?);
                <sql:param value="${id}"></sql:param>
                <sql:param value="${exam_description_id}"></sql:param>
            </sql:update>

            <!--查询数据库表的试题-->
            <sql:query var="questions" scope="session" dataSource="${userdb}">
                ...
                <tr valign="top">
                    <td width="140" id="stuInfo">
                        ...
                        <fieldset style="height: 265px;">
                            ...
                            <sql:query var="studentinfo" scope="session" dataSource="${userdb}">
                                ...
                                <div style="font-weight: bold;font-family: 宋体;">
                                    ...
                                    <div style="float: right;"><table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td> <div  style=""><form action="<%=path%>/_handlechoose" name="form" method="get"><input type="hidden" name="exam_description_id" value="<c:out value="${exam_description_id}"></c:out>"/><input type="submit" value="True" name="chose" class="options"><input type="submit" value="False" name="chose" class="options"></form></div></td>
                                        </tr>
                                    </table>
                                    </div>
                                </div>
                                    ...
                                    <div style="font-weight: bold;font-family: 宋体;">
                                        ...
                                        <div style="float: right;">
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="66" style="font-weight: bold;">选择：</td>
                                                    <td ><div  style=""><form action="<%=path%>/_handlechoose" name="form" method="get"><input type="hidden" name="exam_description_id" value="<c:out value="${exam_description_id}"></c:out>"/><input type="submit" value="A" name="chose" class="options"><input type="submit" value="B" name="chose" class="options"><input type="submit" value="C" name="chose" class="options"><input type="submit" value="D" name="chose" class="options"></form></div></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                            ...
                            <div style="height: 63px;position: relative;top: 13px;">
                                ...
                                <div id="actArea" style="float: right;margin-top: 20px;">
                                    <div>
                                        ...
                                        <form action="<%=path%>/_handlescore" name="form" method="get" id="submit_to_handleScore"><input type="submit" value="交 卷"></form>
                                    </div>
                                </div>
                            </div>
                    </td>
